...
ALTER TABLE public.bowls DISABLE TRIGGER ALL;
...
ALTER TABLE public.bowls ENABLE TRIGGER ALL;

--
-- Data for Name: bowl_favorites; Type: TABLE DATA; Schema: public; Owner: suhrad
--

ALTER TABLE public.bowl_favorites DISABLE TRIGGER ALL;
...
ALTER TABLE public.bowl_favorites ENABLE TRIGGER ALL;

--
-- Data for Name: bowl_follows; Type: TABLE DATA; Schema: public; Owner: suhrad
--

ALTER TABLE public.bowl_follows DISABLE TRIGGER ALL;
...
ALTER TABLE public.bowl_follows ENABLE TRIGGER ALL;
...
ALTER TABLE public.org_trust_votes DISABLE TRIGGER ALL;

COPY public.org_trust_votes (id, user_id, organization_id, trust_vote, created_at) FROM stdin;
\.


ALTER TABLE public.org_trust_votes ENABLE TRIGGER ALL;
...
ALTER TABLE public.poll_votes DISABLE TRIGGER ALL;
...
ALTER TABLE public.poll_votes ENABLE TRIGGER ALL;
