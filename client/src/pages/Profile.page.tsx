      ...
      return (
        <div className="space-y-9">
          ...
          <div className="flex items-center gap-[10px]">
            <button className="flex-1 py-6 bg-[#1B1C20] text-[#525252] text-xs font-medium tracking-wide cursor-not-allowed flex items-center justify-center gap-2">
              <SvgIcon src="/icons/Leaderboard.svg" />
              LEADERBOARD
            </button>
            <button className="flex-1 py-6 bg-[#E8EAE9] text-[#525252] text-xs font-medium tracking-wide hover:bg-gray-200 transition-colors flex items-center justify-center gap-2">
          ...
          <div className="bg-[#1e3a5f] border-l-[5px] border-[#A0D9FF] py-4 px-9">
            <p className="text-[#E0F2FE] text-sm leading-relaxed">
              Everything that you do at anonn generates you points thats
              everything from a comment to upvote to invite and posting. This
              translates directly to the{" "}
              <span className="text-[#7CD4FD] font-semibold">airdrop</span> you
              will receive
            </p>
          </div>
              ...
              >
                ...
                <div className="flex border-t border-[0.2px] border-[#525252]/30 text-[#525252] ">
                  ...
                  <div className="flex items-center justify-center text-[10px] w-1/3 gap-2 py-3 border-r border-[0.2px] border-[#525252]/30">
                    ...
                    <span>
                      {Math.floor((community.memberCount * 1.33) / 1000)}K
                    </span>
                  </div>
                  <div className="flex items-center justify-center text-[10px] w-1/3 gap-2 py-3">
                    <SvgIcon src="/icons/Comments icon.svg" />
                    <span>
                      {Math.floor((community.memberCount * 0.83) / 1000)}K
                    </span>
                  </div>
                </div>

                {/* Leave Button */}
                <button className="w-full py-3 flex items-center justify-center gap-2 text-xs font-normal transition-colors bg-[#e5e5e5] text-black hover:bg-[#d4d4d4]">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-gray-400 text-xs">
                        ...
                        {comment.postId && (
                          <button
                            onClick={() =>
                              (window.location.href = `/post?id=${comment.postId}`)
                            }
  ...
  const TabButton = ({
    ...
    <button
      ...
      className={`flex text-[#525252] items-center gap-2 px-4 h-[40px] sm:px-6  rounded-[56px] text-xs font-medium transition-all w-full sm:w-auto justify-center ${
        activeTab === tab ? "bg-[#E8EAE9]" : "bg-[#1B1C20] hover:text-[#E8EAE9]"
      }`}
    >
      <SvgIcon
        src={icon}
      ...
      <div>
        ...
        <nav className="hidden scrollbar-hide sm:flex items-center gap-2 sm:gap-4 md:px-0 sm:px-6 pb-6 overflow-x-auto">
          <button
            ...
            className={`flex items-center gap-2 px-4 sm:px-6 h-[40px] rounded-[56px] text-xs font-medium transition-all flex-shrink-0 ${
              activeTab === "whistle"
