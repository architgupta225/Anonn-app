...
use super::honk_verifier_circuits::{run_GRUMPKIN_HONK_SUMCHECK_SIZE_18_PUB_101_circuit, run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_18_circuit, is_on_curve_bn254};
...
mod UltraKeccakHonkVerifier {
    ...
    use super::{vk, VK_HASH, precomputed_lines, run_GRUMPKIN_HONK_SUMCHECK_SIZE_18_PUB_101_circuit, run_GRUMPKIN_HONK_PREP_MSM_SCALARS_SIZE_18_circuit, is_on_curve_bn254};
    ...
    use garaga::core::circuit::{U32IntoU384, u288IntoCircuitInputValue, U64IntoU384, };
    ...
    impl IUltraKeccakHonkVerifier of super::IUltraKeccakHonkVerifier<ContractState> {
        fn verify_ultra_keccak_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_18_PUB_101_circuit(
...
full_proof.proof.lookup_read_tags.into(), // Proof point 8
            ...
            }; // log_n -1 = 17 points || Proof points 9-25
            ...
            let mut scalars: Span<u384> = array![scalar_1,
            scalar_2,
            scalar_3,
            scalar_4,
            scalar_5,
